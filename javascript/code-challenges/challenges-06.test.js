...
const getNames = (arr) => { return arr.map ( person => person.name.split('').reduce((reverse, letter) => letter + reverse),'')
  // Solution code here...
};
...
const appendTheEnd = (str) => { return str + ' The end.'
  // Solution code here...
};
...
const addBirthYearProperty = (obj, year) => { obj += obj.yearBorn = year;
  // Solution code here... 
};
