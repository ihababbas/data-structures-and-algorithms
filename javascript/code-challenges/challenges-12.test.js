...
const validatePin = (pin) => {  return /\b[0-9]{4}\b/.test(pin)
  // Solution code here...
};
...
const validateWord = (word) => { return /\b[A-z]{5,10}\b/.test(word)
  // Solution code here...
};
...
const hasNumber = (string) => {   return /^[A-z]{1,}[0-9]{1,}/.test(string)
  // Solution code here...
};
...
const validateEmail = (email) => {
  const regex = /^[A-Za-z0-9]+(\.[A-Za-z0-9]+)?@[a-z]*(\.com|\.net|\.org)$/
