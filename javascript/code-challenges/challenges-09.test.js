...
E.g. [4,2,7,5,9,2] -> 9
------------------------------------------------------------------------------------------------ */
const maxInArray = (arr) => {  return arr.reduce((max, num) => {
...
const getCourseKeys = (obj) => {  return Object.keys(obj)
  // Solution code here...
};
...
const checkValues = (obj, value) => {  return Object.values(obj).includes(value)
  // Solution code here...
};
...
const hasChildrenValues = (arr, character) => {
  let newArr = Object.entries(arr.filter(i => i.name.includes(character))[0])
  let ans = newArr.filter(i => i.includes('children'))
  return ans.length > 0
  // Solution code here...
