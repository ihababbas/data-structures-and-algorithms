...
const updateAnimal = (arr, callback) => {  return arr.map(str => callback(str));
  // Solution code here...
};
...
const sortNumbers = (arr) => {return arr.sort (( a, b ) => a-b);  
  // Solution code here...
};
...
const sortBackwards = (arr) => { return arr.sort((a,b) => b - a)  
  // Solution code here...
};
...
const sortByPrice = (arr) => { return arr.sort((a,b) => a.price - b.price)  
  // Solution code here...
};
