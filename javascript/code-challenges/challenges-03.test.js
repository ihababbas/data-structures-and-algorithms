...
const typeNum = (arr) => {return arr.filter(element => typeof(element) === "number")};
  // Solution code here...
...
const containsAnd = (arr) => { return arr.filter(element => element.includes ('and'))
  // Solution code here... 
};
...
const oddValues = (arr) => { return arr.filter(element => element % 2 === 1 )
  // Solution code here...
};
