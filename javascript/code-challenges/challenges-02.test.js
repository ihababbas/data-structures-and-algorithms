...
const addQuestion = (arr) => { return (arr.map( element => element + "?"))
  // Solution code here...
};
...
const mapTwoToThe = (arr) => { return (arr.map( element => (Math.pow(2,element))))
  // Solution code here...
};
...
const charCode = (arr) => { return arr.map( element => (element.charCodeAt()))
