...
------------------------------------------------------------------------------------------------ */
const toLastNames = people => { return people.map (x => x.firstName + ' ' + x.lastName);
  // Solution code here...
};
...
const addValues = (arr) => {   return arr.reduce( (a,b) => a+b, 0)
  // Solution code here...
};
...
const addPurchases = (arr) => {   return arr.reduce( (a,b) => a + b.purchasePrice, 0)
   // Solution code here...
};
...
const countNumberOfElements = (arr) => { return arr.reduce( (a,b,c) => {
  return c + 1
});
  // Solution code here...
};
...
const reversedString = (str) => { return str.split('').reduce( (a,b) => b+a, '')
  // Solution code here... 
};
